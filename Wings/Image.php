...
final class Image
{
    ...
    private static $extensions = ['jpeg', 'png'];
    ...
    public static function create($type = 'jpeg', $path)
    {
    	$type = str_replace('image/', '', $type);
    
    	if (!\in_array($type, self::$extensions)) return false;
    
    	switch ($type)
    	{
    		case 'jpeg':
    			return new Image\Jpg($path);
    			break;
    		case 'png':
    			return new Image\Png($path);
    			break;
    	}
    }
